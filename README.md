...
Personal dotfiles for **macOS** and **WSL2 (Ubuntu)**. One entrypoint, symlinked configs,
...
The container runs the suite as an unprivileged user on purpose: several failure paths in
